...
import { maybeAutoGenerateDeploymentInvoice } from "@/lib/tasks/invoice-hook";
...
export async function PATCH(
  ...
  try {
    ...
    // Fire-and-forget: auto-generate Wave invoice on website_deployment → deployed
    maybeAutoGenerateDeploymentInvoice({ taskId, toStatus }).catch((err) =>
      console.error("[invoice-hook] Background invoice generation failed:", err)
    );
