...
export const TENANT_REGISTRY: Record<string, TenantConfig> = {
  ...
  ridgeline: {
    ...
    companyName: "Ridgeline Media LLC",
    companyTagline: "Affiliate Portfolio",
    fromEmail: "noreply@ridgelinemedia.co",
    fromName: "Ridgeline Media",
    supportEmail: "hello@ridgelinemedia.co",
    dashboardUrl: "https://ridgeline.covos.app",
    aiContext: "affiliate content website portfolio company",
